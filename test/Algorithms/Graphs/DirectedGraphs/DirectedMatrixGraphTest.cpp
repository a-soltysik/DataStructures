...
TEST_F(DirectedMatrixGraphTest, AddVertexTest)
{
    graph.AddVertex();
...
TEST_F(DirectedMatrixGraphTest, RemoveVertexTest)
{
    graph.AddVertex();
    graph.AddVertex();
    graph.AddVertex();
...
TEST_F(DirectedMatrixGraphTest, AddDirectedEdgeTest)
{
    graph.AddVertex();
    graph.AddVertex();
    graph.AddVertex();
...
TEST_F(DirectedMatrixGraphTest, RemoveDirectedEdgeTest)
{
    graph.AddVertex();
    graph.AddVertex();
    graph.AddVertex();
...
TEST_F(DirectedMatrixGraphTest, GetWeightTest)
{
    graph.AddVertex();
    graph.AddVertex();
    graph.AddVertex();
...
TEST_F(DirectedMatrixGraphTest, SetWeightTest)
{
    graph.AddVertex();
    graph.AddVertex();
    graph.AddVertex();
...
TEST_F(DirectedMatrixGraphTest, DoesExistTest)
{
    graph.AddVertex();
    graph.AddVertex();
    graph.AddVertex();
